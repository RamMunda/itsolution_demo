...
import cloud_animation_pic from '../assets/cloud_animation.PNG';
const CloudHosting = () => {
    return ( 
        <>
        <div className="cloud_host_wrapper">
            <div className="cloud_content">
                <div className="cloude_hosting_detail">
                ...
                <div className="cloud_hosting_animation">

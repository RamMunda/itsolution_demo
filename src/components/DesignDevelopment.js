import Cloud_Host_pic from '../assets/cercle-shape.png';
import cloud_animation_pic from '../assets/designdev.PNG';
const DesignDevelopment = () => {
    return ( 
        <>
        <div className="cloud_host_wrapper designDev_wrapper">
            <div className="cloud_content designDev_Content">
                <div className="cloude_hosting_detail designdevelop">
                    <h1>Design & Development</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <div className="cloud_hosting_category">
                ...
                <div className="cloud_hosting_animation designdevPic">
                    <img src={Cloud_Host_pic} alt="cloud_hosting" />
                    <div className="cloud_animation_pics">
                        <img src={cloud_animation_pic} alt="cloud_animation_pic" />
                    </div>
                </div>
            </div>
        </div>
